...
names(pvia_5) <- c("newspaper_ref", "month", 
                   ...
                   "type_group_target", "type_perpetrator", 
                   "type_group_perpetrator")

# selecting relevant level of violence: "group deadly assault (lynching, homocide)
pvia_5 %>% filter(group_violence == "6")
...
pvia_5$nature_target <- recode(pvia_5$nature_target,
       "2" = "Cabinet Member",
...
spec_pvia_5$individual_violence <- recode(spec_pvia_5$individual_violence,
       "4" = "pistol")
...
spec_pvia_5$type_group_target <- recode(spec_pvia_5$type_group_target,
      "0" = "Racial group",
      "4" = "Political group",
      "5" = "Social protest group")

# recode type of perpetrator
spec_pvia_5$type_perpetrator <- recode(spec_pvia_5$type_perpetrator,
      "0" = "Federal office holder",
      "3" = "Primary political affiliation",
      "5" = "Primary racial affiliation")

# recode type of group perpetrator
spec_pvia_5$type_group_perpetrator <- recode(spec_pvia_5$type_group_perpetrator,
      "0" = "Racial group",
      "4" = "Political group")
